...
; TODO's :
; (1) We use various terms for the "same" thing: shortline coastline and coast_line, we need one word for that
; (2) Stop when done, or do some final things like David suggested
; (3) make sure that other depots get some attractiveness, not always the closest one
