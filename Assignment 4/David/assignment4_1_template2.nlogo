...
; 2) visualization: visualization agent
breed [link_agents link_agent ]
...
to setup-patches
  ...
  let patch_color_value 15
  let max_num  0
  while [max_num != num_agents]
        [ask n-of (total_dirty / num_agents) patches
          [set pcolor patch_color_value
           set patch_color_value patch_color_value + 10
           ]
